...
A continuación, se han evaluado dos estudios alternativos de control fuzzy para la calidad ambiental de interior.
...
Se llevaron a cabo experimentos tanto en simulaciones como en entornos reales. Las primeras permitieron evaluar durante períodos de 10 días las distintas configuraciones del controlador bajo condiciones climáticas específicas; mientras que las segundas proporcionaron validación en condiciones más realistas. Los resultados se compararon con un controlador convencional On-Off y con versiones iniciales no optimizadas del FLC para medir la mejora alcanzada.
